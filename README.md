...
[![1つのプロンプトを6〜20件の調査タスクへ分け、全サブエージェントがGPT-5.6 Lunaであることを確認して引用付き最終レポートへ統合する流れ](docs/assets/one-prompt-research-flow.png)](docs/assets/one-prompt-research-flow.png)
